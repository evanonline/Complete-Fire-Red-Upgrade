...
.equ ABILITY_CLOUDNINE, 0xD @;Also Air Lock
.equ ABILITY_COMPOUNDEYES, 0xE
.equ ABILITY_INSOMNIA, 0xF @;Also Vital Spirit
...
.equ ABILITY_CLEARBODY, 0x1D @;Also White Smoke
...
.equ ABILITY_OVERGROW_BLAZE_TORRENT_SWARM, 0x41
.equ ABILITY_WINDRIDER, 0x42
.equ ABILITY_WINDPOWER, 0x43
.equ ABILITY_GOODASGOLD, 0x44
.equ ABILITY_ROCKHEAD, 0x45
.equ ABILITY_DROUGHT, 0x46
.equ ABILITY_ARENATRAP, 0x47
.equ ABILITY_TYPE_DAMAGE_BOOST, 0x48 @;Was ABILITY_VITALSPIRIT
.equ ABILITY_PARADOX_ABILITIES, 0x49 @;Was ABILITY_WHITESMOKE
.equ ABILITY_NEUTRALIZINGGAS, 0x4A @;Was ABILITY_PUREPOWER
.equ ABILITY_SHELLARMOR, 0x4B
.equ ABILITY_HUNGERSWITCH, 0x4C
.equ ABILITY_OF_RUIN, 0x4D
...
.equ ABILITY_FILTER, 0x65 @;Also Solid Rock
...
.equ ABILITY_MOXIE, 0x76 @;Also Grim Neigh
.equ ABILITY_AFTERMATH, 0x77
.equ ABILITY_CURSEDBODY, 0x78
.equ ABILITY_GOOEY, 0x79 @;Also Tangling Hair
.equ ABILITY_MUMMY, 0x7A
.equ ABILITY_GRIMNEIGH, 0x7B
...
.equ ABILITY_MOLDBREAKER, 0x98 @;Also Turboblaze, Teravolt
...
.equ ABILITY_MYCELIUMMIGHT, 0xAE
...
.equ ABILITY_DAZZLING, 0xDD @;Also Queenly Majesty
...
.equ MOVE_BARBBARRAGE, 0x2E7
.equ MOVE_WAVECRASH, 0x2E8
.equ MOVE_PSYSHIELDBASH, 0x2E9
.equ MOVE_DIRECLAW, 0x2EA
.equ MOVE_INFERNALPARADE, 0x2EB
.equ MOVE_CEASELESSEDGE, 0x2EC
.equ MOVE_TRIPLEARROWS, 0x2ED
.equ MOVE_STONEAXE, 0x2EE
.equ MOVE_MOUNTAINGALE, 0x2EF
.equ MOVE_ESPERWING, 0x2F0
.equ MOVE_CHLOROBLAST, 0x2F1
.equ MOVE_BITTERMALICE, 0x2F2

.equ MOVE_SCRUNCH, 0x2F3
.equ MOVE_JAB, 0x2F4
.equ MOVE_SPECIAL_PUNCH, 0x2F5
.equ MOVE_LEEK_SLAP, 0x2F6
.equ MOVE_POT_SMASH, 0x2F7

.equ MOVE_SPRINGTIDESTORM, 0x2F8
.equ MOVE_BLEAKWINDSTORM, 0x2F9
.equ MOVE_WILDBOLTSTORM, 0x2FA
.equ MOVE_SANDSEARSTORM, 0x2FB
.equ MOVE_RAGINGFURY, 0x2FC
.equ MOVE_POWERSHIFT, 0x2FD
.equ MOVE_HEADLONGRUSH, 0x2FE
.equ MOVE_SHELTER, 0x2FF
.equ MOVE_LUNARBLESSING, 0x300
.equ MOVE_VICTORYDANCE, 0x301
.equ MOVE_MYSTICALPOWER, 0x302
.equ MOVE_TAKEHEART, 0x303

.equ MOVE_SILKTRAP, 0x304
.equ MOVE_AXEKICK, 0x305
.equ MOVE_LASTRESPECTS, 0x306
.equ MOVE_LUMINACRASH, 0x307
.equ MOVE_JETPUNCH, 0x308
.equ MOVE_SPICYEXTRACT, 0x309
.equ MOVE_SPINOUT, 0x30A
.equ MOVE_POPULATIONBOMB, 0x30B
.equ MOVE_ICESPINNER, 0x30C 
.equ MOVE_GLAIVERUSH, 0x30D
.equ MOVE_REVIVALBLESSING, 0x30E
.equ MOVE_SALTCURE, 0x30F
.equ MOVE_TRIPLEDIVE, 0x310
.equ MOVE_MORTALSPIN, 0x311
.equ MOVE_DOODLE, 0x312
.equ MOVE_FILLETAWAY, 0x313
.equ MOVE_FLOWERTRICK, 0x314
.equ MOVE_TORCHSONG, 0x315
.equ MOVE_AQUASTEP, 0x316
.equ MOVE_RAGINGBULL, 0x317
.equ MOVE_MAKEITRAIN, 0x318
.equ MOVE_PSYBLADE, 0x319
.equ MOVE_RUINATION, 0x31A
.equ MOVE_HYDROSTEAM, 0x31B
.equ MOVE_COLLISIONCOURSE, 0x31C
.equ MOVE_ELECTRODRIFT, 0x31D
.equ MOVE_SHEDTAIL, 0x31E
.equ MOVE_CHILLYRECEPTION, 0x31F
.equ MOVE_TIDYUP, 0x320
.equ MOVE_POUNCE, 0x321
.equ MOVE_TRAILBLAZE, 0x322
.equ MOVE_CHILLINGWATER, 0x323
.equ MOVE_KOWTOWCLEAVE, 0x324
.equ MOVE_HYPERDRILL, 0x325
.equ MOVE_TWINBEAM, 0x326
.equ MOVE_RAGEFIST, 0x327
.equ MOVE_GIGATONHAMMER, 0x328
.equ MOVE_ARMORCANNON, 0x329
.equ MOVE_BITTERBLADE, 0x32A
.equ MOVE_DOUBLESHOCK, 0x32B
.equ MOVE_COMEUPPANCE, 0x32C
.equ MOVE_AQUACUTTER, 0x32D
.equ MOVE_BLOODMOON, 0x32E
.equ MOVE_MATCHAGOTCHA, 0x32F
.equ MOVE_SYRUPBOMB, 0x330
.equ MOVE_FICKLEBEAM, 0x331
.equ MOVE_DRAGONCHEER, 0x332
.equ MOVE_ELECTROSHOT, 0x333
.equ MOVE_BURNINGBULWARK, 0x334
.equ MOVE_THUNDERCLAP, 0x335
.equ MOVE_TACHYONCUTTER, 0x336
.equ MOVE_HARDPRESS, 0x337
.equ MOVE_MIGHTYCLEAVE, 0x338
.equ MOVE_ALLURINGVOICE, 0x339
.equ MOVE_TEMPERFLARE, 0x33A
.equ MOVE_SUPERCELLSLAM, 0x33B
.equ MOVE_PSYCHICNOISE, 0x33C
.equ MOVE_UPPERHAND, 0x33D
.equ MOVE_MALIGNANTCHAIN, 0x33E
.equ MOVE_ORDERUP, 0x33F
.equ MOVE_IVYCUDGEL, 0x340
.equ MOVE_TERABLAST, 0x341
.equ MOVE_TERASTARSTORM, 0x342

.equ MOVE_BREAKNECK_BLITZ_P, 0x344
.equ MOVE_BREAKNECK_BLITZ_S, 0x345
.equ MOVE_ALL_OUT_PUMMELING_P, 0x346
.equ MOVE_ALL_OUT_PUMMELING_S, 0x347
.equ MOVE_SUPERSONIC_SKYSTRIKE_P, 0x348
.equ MOVE_SUPERSONIC_SKYSTRIKE_S, 0x349
.equ MOVE_ACID_DOWNPOUR_P, 0x34A
.equ MOVE_ACID_DOWNPOUR_S, 0x34B
.equ MOVE_TECTONIC_RAGE_P, 0x34C
.equ MOVE_TECTONIC_RAGE_S, 0x34D
.equ MOVE_CONTINENTAL_CRUSH_P, 0x34E
.equ MOVE_CONTINENTAL_CRUSH_S, 0x34F
.equ MOVE_SAVAGE_SPIN_OUT_P, 0x350
.equ MOVE_SAVAGE_SPIN_OUT_S, 0x351
.equ MOVE_NEVER_ENDING_NIGHTMARE_P, 0x352
.equ MOVE_NEVER_ENDING_NIGHTMARE_S , 0x353
.equ MOVE_CORKSCREW_CRASH_P, 0x354
.equ MOVE_CORKSCREW_CRASH_S, 0x355
.equ MOVE_INFERNO_OVERDRIVE_P, 0x356
.equ MOVE_INFERNO_OVERDRIVE_S, 0x357
.equ MOVE_HYDRO_VORTEX_P, 0x358
.equ MOVE_HYDRO_VORTEX_S, 0x359 
.equ MOVE_BLOOM_DOOM_P, 0x35A
.equ MOVE_BLOOM_DOOM_S, 0x35B
.equ MOVE_GIGAVOLT_HAVOC_P, 0x35C
.equ MOVE_GIGAVOLT_HAVOC_S, 0x35D
.equ MOVE_SHATTERED_PSYCHE_P, 0x35E
.equ MOVE_SHATTERED_PSYCHE_S, 0x35F
.equ MOVE_SUBZERO_SLAMMER_P, 0x360
.equ MOVE_SUBZERO_SLAMMER_S, 0x361
.equ MOVE_DEVASTATING_DRAKE_P, 0x362
.equ MOVE_DEVASTATING_DRAKE_S, 0x363
.equ MOVE_BLACK_HOLE_ECLIPSE_P, 0x364
.equ MOVE_BLACK_HOLE_ECLIPSE_S, 0x365
.equ MOVE_TWINKLE_TACKLE_P , 0x366
.equ MOVE_TWINKLE_TACKLE_S, 0x367

.equ MOVE_CATASTROPIKA, 0x368
.equ MOVE_10000000_VOLT_THUNDERBOLT, 0x369
.equ MOVE_STOKED_SPARKSURFER, 0x36A
.equ MOVE_EXTREME_EVOBOOST, 0x36B
.equ MOVE_PULVERIZING_PANCAKE, 0x36C
.equ MOVE_GENESIS_SUPERNOVA, 0x36D
.equ MOVE_SINISTER_ARROW_RAID, 0x36E
.equ MOVE_MALICIOUS_MOONSAULT, 0x36F
.equ MOVE_OCEANIC_OPERETTA, 0x370
.equ MOVE_SPLINTERED_STORMSHARDS, 0x371
.equ MOVE_LETS_SNUGGLE_FOREVER, 0x372
.equ MOVE_CLANGOROUS_SOULBLAZE, 0x373
.equ MOVE_GUARDIAN_OF_ALOLA, 0x374
.equ MOVE_SEARING_SUNRAZE_SMASH, 0x375
.equ MOVE_MENACING_MOONRAZE_MAELSTROM, 0x376
.equ MOVE_LIGHT_THAT_BURNS_THE_SKY, 0x377
.equ MOVE_SOUL_STEALING_7_STAR_STRIKE, 0x378
...
.equ ITEM_EFFECT_CHRONO_ORB, 138
.equ ITEM_EFFECT_ENERGY_BUSTER, 139
.equ ITEM_EFFECT_GRISEOUS_CORE, 140
.equ ITEM_EFFECT_GROWTH_TAPPER, 141
.equ ITEM_EFFECT_SPIRIT_MOTOR, 142

.equ ITEM_EFFECT_ADAMANT_CRYSTAL, 143
.equ ITEM_EFFECT_LUSTROUS_GLOBE, 144

.equ ITEM_EFFECT_LOADED_DICE, 145
...
.equ SPECIES_GROWLITHE_H, 0x4FB
.equ SPECIES_ARCANINE_H, 0x4FC
.equ SPECIES_VOLTORB_H, 0x4FD
.equ SPECIES_ELECTRODE_H, 0x4FE
.equ SPECIES_TYPHLOSION_H, 0x4FF
.equ SPECIES_QWILFISH_H, 0x500
.equ SPECIES_SNEASEL_H, 0x501
.equ SPECIES_SAMUROTT_H, 0x502
.equ SPECIES_LILLIGANT_H, 0x503
.equ SPECIES_ZORUA_H, 0x504
.equ SPECIES_ZOROARK_H, 0x505
.equ SPECIES_BRAVIARY_H, 0x506
.equ SPECIES_SLIGGOO_H, 0x507
.equ SPECIES_GOODRA_H, 0x508
.equ SPECIES_AVALUGG_H, 0x509
.equ SPECIES_DECIDUEYE_H, 0x50A

.equ SPECIES_PIKACHU_CAP_WORLD, 0x50B
.equ SPECIES_BASCULIN_WHITE, 0x50C
.equ SPECIES_BASCULEGION_FEMALE, 0x50D
.equ SPECIES_PALKIA_ORIGIN, 0x50E
.equ SPECIES_DIALGA_ORIGIN, 0x50F
.equ SPECIES_ENAMORUS_THERIAN, 0x510

.equ SPECIES_PROTOCEUS, 0x398
.equ SPECIES_MISSINGNO, 0x2C2

.equ SPECIES_ROTOM_ROTOMI, 0x4CC
.equ SPECIES_STOUTLAND_ETERNAL, 0x40C
.equ SPECIES_CHARIZARD_MONO, 0x40E

.equ SPECIES_VENUSAUR_F, 0x511
.equ SPECIES_RATTATA_F, 0x512
.equ SPECIES_RATICATE_F, 0x513
.equ SPECIES_PIKACHU_F, 0x514
.equ SPECIES_RAICHU_F, 0x515
.equ SPECIES_ZUBAT_F, 0x516
.equ SPECIES_GOLBAT_F, 0x517
.equ SPECIES_GLOOM_F, 0x518
.equ SPECIES_VILEPLUME_F, 0x519
.equ SPECIES_KADABRA_F, 0x51A
.equ SPECIES_ALAKAZAM_F, 0x51B
.equ SPECIES_DODUO_F, 0x51C
.equ SPECIES_DODRIO_F, 0x51D
.equ SPECIES_HYPNO_F, 0x51E
.equ SPECIES_RHYHORN_F, 0x51F
.equ SPECIES_RHYDON_F, 0x520
.equ SPECIES_GOLDEEN_F, 0x521
.equ SPECIES_SEAKING_F, 0x522
.equ SPECIES_SCYTHER_F, 0x523
.equ SPECIES_MAGIKARP_F, 0x524
.equ SPECIES_GYARADOS_F, 0x525
.equ SPECIES_EEVEE_F, 0x526
.equ SPECIES_MEGANIUM_F, 0x527
.equ SPECIES_LEDYBA_F, 0x528
.equ SPECIES_LEDIAN_F, 0x529
.equ SPECIES_XATU_F, 0x52A
.equ SPECIES_SUDOWOODO_F, 0x52B
.equ SPECIES_POLITOED_F, 0x52C
.equ SPECIES_AIPOM_F, 0x52D
.equ SPECIES_WOOPER_F, 0x52E
.equ SPECIES_QUAGSIRE_F, 0x52F
.equ SPECIES_MURKROW_F, 0x530
.equ SPECIES_WOBBUFFET_F, 0x531
.equ SPECIES_GIRAFARIG_F, 0x532
.equ SPECIES_GLIGAR_F, 0x533
.equ SPECIES_STEELIX_F, 0x534
.equ SPECIES_SCIZOR_F, 0x535
.equ SPECIES_HERACROSS_F, 0x536
.equ SPECIES_SNEASEL_F, 0x537
.equ SPECIES_URSARING_F, 0x538
.equ SPECIES_PILOSWINE_F, 0x539
.equ SPECIES_OCTILLERY_F, 0x53A
.equ SPECIES_HOUNDOOM_F, 0x53B
.equ SPECIES_DONPHAN_F, 0x53C
.equ SPECIES_TORCHIC_F, 0x53D
.equ SPECIES_COMBUSKEN_F, 0x53E
.equ SPECIES_BLAZIKEN_F, 0x53F
.equ SPECIES_BEAUTIFLY_F, 0x540
.equ SPECIES_DUSTOX_F, 0x541
.equ SPECIES_LUDICOLO_F, 0x542
.equ SPECIES_NUZLEAF_F, 0x543
.equ SPECIES_SHIFTRY_F, 0x544
.equ SPECIES_MILOTIC_F, 0x545
.equ SPECIES_NUMEL_F, 0x546
.equ SPECIES_CAMERUPT_F, 0x547
.equ SPECIES_CACTURNE_F, 0x548
.equ SPECIES_MEDITITE_F, 0x549
.equ SPECIES_MEDICHAM_F, 0x54A
.equ SPECIES_ROSELIA_F, 0x54B
.equ SPECIES_GULPIN_F, 0x54C
.equ SPECIES_SWALOT_F, 0x54D
.equ SPECIES_RELICANTH_F, 0x54E
.equ SPECIES_STARLY_F, 0x54F
.equ SPECIES_STARAVIA_F, 0x550
.equ SPECIES_STARAPTOR_F, 0x551
.equ SPECIES_BIDOOF_F, 0x552
.equ SPECIES_BIBAREL_F, 0x553
.equ SPECIES_KRICKETOT_F, 0x554
.equ SPECIES_KRICKETUNE_F, 0x555
.equ SPECIES_SHINX_F, 0x556
.equ SPECIES_LUXIO_F, 0x557
.equ SPECIES_LUXRAY_F, 0x558
.equ SPECIES_ROSERADE_F, 0x559
.equ SPECIES_COMBEE_F, 0x55A
.equ SPECIES_PACHIRISU_F, 0x55B
.equ SPECIES_BUIZEL_F, 0x55C
.equ SPECIES_FLOATZEL_F, 0x55D
.equ SPECIES_AMBIPOM_F, 0x55E
.equ SPECIES_GIBLE_F, 0x55F
.equ SPECIES_GABITE_F, 0x560
.equ SPECIES_GARCHOMP_F, 0x561
.equ SPECIES_CROAGUNK_F, 0x562
.equ SPECIES_TOXICROAK_F, 0x563
.equ SPECIES_FINNEON_F, 0x564
.equ SPECIES_LUMINEON_F, 0x565
.equ SPECIES_SNOVER_F, 0x566
.equ SPECIES_ABOMASNOW_F, 0x567
.equ SPECIES_WEAVILE_F, 0x568
.equ SPECIES_TANGROWTH_F, 0x569
.equ SPECIES_MAMOSWINE_F, 0x56A
.equ SPECIES_SNEASEL_H_F, 0x56B
.equ SPECIES_RHYPERIOR_F, 0x56C
.equ SPECIES_BUTTERFREE_F, 0x56D

.equ SPECIES_SPRIGATITO, 0x56E
.equ SPECIES_FLORAGATO, 0x56F
.equ SPECIES_MEOWSCARADA, 0x570
.equ SPECIES_FUECOCO, 0x571
.equ SPECIES_CROCALOR, 0x572
.equ SPECIES_SKELEDIRGE, 0x573
.equ SPECIES_QUAXLY, 0x574
.equ SPECIES_QUAXWELL, 0x575
.equ SPECIES_QUAQUAVAL, 0x576
.equ SPECIES_LECHONK, 0x577
.equ SPECIES_OINKOLOGNE, 0x578
.equ SPECIES_TAROUNTULA, 0x579
.equ SPECIES_SPIDOPS, 0x57A
.equ SPECIES_NYMBLE, 0x57B
.equ SPECIES_LOKIX, 0x57C
.equ SPECIES_PAWMI, 0x57D
.equ SPECIES_PAWMO, 0x57E
.equ SPECIES_PAWMOT, 0x57F
.equ SPECIES_TANDEMAUS, 0x580
.equ SPECIES_MAUSHOLD, 0x581
.equ SPECIES_FIDOUGH, 0x582
.equ SPECIES_DACHSBUN, 0x583
.equ SPECIES_SMOLIV, 0x584
.equ SPECIES_DOLLIV, 0x585
.equ SPECIES_ARBOLIVA, 0x586
.equ SPECIES_SQUAWKABILLY, 0x587
.equ SPECIES_NACLI, 0x588
.equ SPECIES_NACLSTACK, 0x589
.equ SPECIES_GARGANACL, 0x58A
.equ SPECIES_CHARCADET, 0x58B
.equ SPECIES_ARMAROUGE, 0x58C
.equ SPECIES_CERULEDGE, 0x58D
.equ SPECIES_TADBULB, 0x58E
.equ SPECIES_BELLIBOLT, 0x58F
.equ SPECIES_WATTREL, 0x590
.equ SPECIES_KILOWATTREL, 0x591
.equ SPECIES_MASCHIFF, 0x592
.equ SPECIES_MABOSSTIFF, 0x593
.equ SPECIES_SHROODLE, 0x594
.equ SPECIES_GRAFAIAI, 0x595
.equ SPECIES_BRAMBLIN, 0x596
.equ SPECIES_BRAMBLEGHAST, 0x597
.equ SPECIES_TOEDSCOOL, 0x598
.equ SPECIES_TOEDSCRUEL, 0x599
.equ SPECIES_KLAWF, 0x59A
.equ SPECIES_CAPSAKID, 0x59B
.equ SPECIES_SCOVILLAIN, 0x59C
.equ SPECIES_RELLOR, 0x59D
.equ SPECIES_RABSCA, 0x59E
.equ SPECIES_FLITTLE, 0x59F
.equ SPECIES_ESPATHRA, 0x5A0
.equ SPECIES_TINKATINK, 0x5A1
.equ SPECIES_TINKATUFF, 0x5A2
.equ SPECIES_TINKATON, 0x5A3
.equ SPECIES_WIGLETT, 0x5A4
.equ SPECIES_WUGTRIO, 0x5A5
.equ SPECIES_BOMBIRDIER, 0x5A6
.equ SPECIES_FINIZEN, 0x5A7
.equ SPECIES_PALAFIN, 0x5A8
.equ SPECIES_VAROOM, 0x5A9
.equ SPECIES_REVAVROOM, 0x5AA
.equ SPECIES_CYCLIZAR, 0x5AB
.equ SPECIES_ORTHWORM, 0x5AC
.equ SPECIES_GLIMMET, 0x5AD
.equ SPECIES_GLIMMORA, 0x5AE
.equ SPECIES_GREAVARD, 0x5AF
.equ SPECIES_HOUNDSTONE, 0x5B0
.equ SPECIES_FLAMIGO, 0x5B1
.equ SPECIES_CETODDLE, 0x5B2
.equ SPECIES_CETITAN, 0x5B3
.equ SPECIES_VELUZA, 0x5B4
.equ SPECIES_DONDOZO, 0x5B5
.equ SPECIES_TATSUGIRI_CURLY, 0x5B6
.equ SPECIES_ANNIHILAPE, 0x5B7
.equ SPECIES_CLODSIRE, 0x5B8
.equ SPECIES_FARIGIRAF, 0x5B9
.equ SPECIES_DUDUNSPARCE, 0x5BA
.equ SPECIES_KINGAMBIT, 0x5BB
.equ SPECIES_GREAT_TUSK, 0x5BC
.equ SPECIES_SCREAM_TAIL, 0x5BD
.equ SPECIES_BRUTE_BONNET, 0x5BE
.equ SPECIES_FLUTTER_MANE, 0x5BF
.equ SPECIES_SLITHER_WING, 0x5C0
.equ SPECIES_SANDY_SHOCKS, 0x5C1
.equ SPECIES_IRON_TREADS, 0x5C2
.equ SPECIES_IRON_BUNDLE, 0x5C3
.equ SPECIES_IRON_HANDS, 0x5C4
.equ SPECIES_IRON_JUGULIS, 0x5C5
.equ SPECIES_IRON_MOTH, 0x5C6
.equ SPECIES_IRON_THORNS, 0x5C7
.equ SPECIES_FRIGIBAX, 0x5C8
.equ SPECIES_ARCTIBAX, 0x5C9
.equ SPECIES_BAXCALIBUR, 0x5CA
.equ SPECIES_GIMMIGHOUL, 0x5CB
.equ SPECIES_GHOLDENGO, 0x5CC
.equ SPECIES_WO_CHIEN, 0x5CD
.equ SPECIES_CHIEN_PAO, 0x5CE
.equ SPECIES_TING_LU, 0x5CF
.equ SPECIES_CHI_YU, 0x5D0
.equ SPECIES_ROARING_MOON, 0x5D1
.equ SPECIES_IRON_VALIANT, 0x5D2
.equ SPECIES_KORAIDON, 0x5D3
.equ SPECIES_MIRAIDON, 0x5D4
.equ SPECIES_WALKING_WAKE, 0x5D5
.equ SPECIES_IRON_LEAVES, 0x5D6
.equ SPECIES_DIPPLIN, 0x5D7
.equ SPECIES_POLTCHAGEIST, 0x5D8
.equ SPECIES_SINISTCHA, 0x5D9
.equ SPECIES_OKIDOGI, 0x5DA
.equ SPECIES_MUNKIDORI, 0x5DB
.equ SPECIES_FEZANDIPITI, 0x5DC
.equ SPECIES_OGERPON, 0x5DD

.equ SPECIES_ROCKRUFF_OWNTEMPO, 0x4C2 //was Koffing G

.equ SPECIES_WOOPER_P, 0x5DE
.equ SPECIES_TAUROS_P, 0x5DF
.equ SPECIES_TAUROS_P_BLAZE, 0x5E0
.equ SPECIES_TAUROS_P_AQUA, 0x5E1

.equ SPECIES_OINKOLOGNE_FEMALE, 0x5E2 
.equ SPECIES_DUDUNSPARCE_THREESEGMENT, 0x5E3 
.equ SPECIES_PALAFIN_HERO, 0x5E4
.equ SPECIES_MAUSHOLD_FAMILYOF3, 0x5E5
.equ SPECIES_TATSUGIRI_DROOPY, 0x5E6
.equ SPECIES_TATSUGIRI_STRETCHY, 0x5E7
.equ SPECIES_SQUAWKABILLY_2, 0x5E8
.equ SPECIES_SQUAWKABILLY_3, 0x5E9
.equ SPECIES_SQUAWKABILLY_4, 0x5EA
.equ SPECIES_GIMMIGHOUL_ROAMING, 0x5EB
.equ SPECIES_URSALUNA_BLOODMOON, 0x5EC
.equ SPECIES_POLTCHAGEIST_ARTISAN, 0x5ED
.equ SPECIES_SINISTCHA_MASTERPIECE, 0x5EE
.equ SPECIES_OGERPON_WELLSPRING, 0x5EF
.equ SPECIES_OGERPON_HEARTHFLAME, 0x5F0
.equ SPECIES_OGERPON_CORNERSTONE, 0x5F1

.equ SPECIES_ARCHALUDON, 0x5F2
.equ SPECIES_HYDRAPPLE, 0x5F3
.equ SPECIES_GOUGING_FIRE, 0x5F4
.equ SPECIES_RAGING_BOLT, 0x5F5
.equ SPECIES_IRON_BOULDER, 0x5F6
.equ SPECIES_IRON_CROWN, 0x5F7
.equ SPECIES_TERAPAGOS, 0x5F8
.equ SPECIES_PECHARUNT, 0x5F9
.equ SPECIES_TERAPAGOS_TERASTAL, 0x5FA
.equ SPECIES_TERAPAGOS_STELLAR, 0x5FB
...
.equ ITEM_CHRONO_ORB, 0x2D9
.equ ITEM_GMAXITE, 0x2DA
.equ ITEM_DARK_SCROLL, 0x2DB
.equ ITEM_DAMP_SCROLL, 0x2DC
.equ ITEM_MELTAN_CANDYJAR, 0x2DD
.equ ITEM_SWAP_ARMOR, 0x2DE
.equ ITEM_ENERGY_BUSTER, 0x2DF
.equ ITEM_BLACK_AUGURITE, 0x2E0
.equ ITEM_PEAT_BLOCK, 0x2E1
.equ ITEM_LEGEND_PLATE, 0x2E2
.equ ITEM_GROWTH_TAPPER, 0x2E3
.equ ITEM_SPIRIT_MOTOR, 0x2E4
.equ ITEM_ADAMANT_CRYSTAL, 0x2E5
.equ ITEM_LUSTROUS_GLOBE, 0x2E6
.equ ITEM_REINS_OF_UNITY, 0x2E7
.equ ITEM_LOADED_DICE, 0x2E8
