...
const u16 gClassBasedTrainerEncounterBGM[NUM_TRAINER_CLASSES] =
{
	...
	[CLASS_ROCKET_GRUNT] = BGM_EYE_CREEPY,
	[CLASS_BATTLE_GIRL] = BGM_EYE_GIRL,
...
const u16 gClassBasedBattleBGM[NUM_TRAINER_CLASSES] =
{
	...
	[CLASS_GYM_LEADER] = BGM_BATTLE_GYM_LEADER,
	[CLASS_ELITE_FOUR] = BGM_BATTLE_GYM_LEADER,
	[CLASS_ROCKET_GRUNT] = BGM_BATTLE_ROCKET_GRUNT,
	[CLASS_ROCKET_DUO] = BGM_BATTLE_RAINBOW_ROCKET,
};
