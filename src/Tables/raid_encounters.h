...
const struct RaidData gRaidsByMapSection[KANTO_MAPSEC_COUNT][RAID_STAR_COUNT] =
{
	...
	//[MAPSEC_UNKNOWN_TOWER - MAPSEC_DYNAMIC] =
	//{
	//	[ONE_STAR_RAID] = {sUnknownTowerRaids2Star, NELEMS(sUnknownTowerRaids2Star)},
	//	[TWO_STAR_RAID] = {sUnknownTowerRaids2Star, NELEMS(sUnknownTowerRaids2Star)},
	//	[THREE_STAR_RAID] = {sUnknownTowerRaids3Star, NELEMS(sUnknownTowerRaids3Star)},
	//	[FOUR_STAR_RAID] = {sUnknownTowerRaids4Star, NELEMS(sUnknownTowerRaids4Star)},
	//	[FIVE_STAR_RAID] = {sUnknownTowerRaids5Star, NELEMS(sUnknownTowerRaids5Star)},
	//	[SIX_STAR_RAID] = {sUnknownTowerRaids6Star, NELEMS(sUnknownTowerRaids6Star)},
	//},
	[MAPSEC_ROUTE_7 - MAPSEC_DYNAMIC] =
	{
