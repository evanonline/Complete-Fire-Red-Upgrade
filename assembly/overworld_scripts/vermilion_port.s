...
gMapScripts_VermilionIntroSibSpriteScript_Hotel1:
   mapscript MAP_SCRIPT_ON_LOAD EventScript_SibStartEvent_Hotel1
   .byte MAP_SCRIPT_TERMIN

EventScript_SibStartEvent_Hotel1:
	setflag 0x951
	hidesprite 2
	checkflag FLAG_RUN_START
	if 0x0 _goto EventScript_ChangeSibSprite_Hotel1
	end
...
EventScript_VermilionIntro_SibEntry:
	lock
	setvar 0x511A 0x1
	checkgender
    compare LASTRESULT 0x0
    if 0x1 _goto EventScript_SibRoom_NameSherry0
    compare LASTRESULT 0x1
    if 0x1 _goto EventScript_SibRoom_NameBrandy0
	

EventScript_SibRoom_NameSherry0:
	...
	setvar 0x8003 0x2
	callasm 0x8FB0001
	goto EventScript_SibRoomEnterMoveTalk
	end

EventScript_SibRoom_NameBrandy0:
...
EventScript_SibRoomEnterMoveTalk:
	opendoor 0x3 0x1
	waitdooranim
	setflag 0x951
	showsprite 2
	msgbox gText_OpeningSibEntry MSG_KEEPOPEN
	applymovement 0x2 EventScript_SibEntry_Move
	closedoor 0x3 0x1
	waitmovement 0x0
	applymovement 0x2 EventScript_SibEntry_LookAtPC
	waitmovement 0x0
	msgbox gText_OpeningOptionsStart MSG_KEEPOPEN
	applymovement 0x2 EventScript_SibEntry_Reset
	msgbox gText_OpeningOptionsStart2 MSG_KEEPOPEN
	waitmsg
	closeonkeypress
	callasm 0x8FB0101
	release
...
EventScript_SibEntry_Move:
	.byte walk_down
	.byte 0xFE

EventScript_SibEntry_LookAtPC:
	.byte look_left
	.byte 0xFE

EventScript_SibEntry_Reset:
	.byte look_down
	.byte 0xFE
