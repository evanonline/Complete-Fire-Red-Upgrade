...
enum
{
	...
	CLASS_FISHER, 				//0x44
	CLASS_SWIMMER, 				//0x45
	CLASS_FIREBREATHER, 		//0x46
	CLASS_GAMER, 				//0x47
	CLASS_PSYCHIC,	 			//0x48
	CLASS_KRICKETINA, 			//0x49
	CLASS_DRAGON_TAMER, 		//0x4A
	CLASS_CHERISH_BALLER, 		//0x4B
	CLASS_BLACK_BELT, 			//0x4C
	CLASS_CHASER, 				//0x4D
	CLASS_MAD_SCIENTIST,		//0x4E
	CLASS_ROCKET_BOSS, 			//0x4F
	CLASS_ROCKET_GRUNT, 		//0x50
	CLASS_ACE_TRAINER, 			//0x51
	CLASS_ELITE_FOUR, 			//0x52
	CLASS_GYM_LEADER, 			//0x53
	CLASS_CHAMPION,		 		//0x54
	CLASS_GHOST_HUNTER, 		//0x55
	CLASS_CHANNELER, 			//0x56
	CLASS_TWINS, 				//0x57
	CLASS_DETECTIVES, 			//0x58
	CLASS_YOUNG_COUPLE, 		//0x59
	CLASS_MIGHTY_LOVERS,		//0x5A
	CLASS_WINTRY_IDOL,	 		//0x5B
	CLASS_PROFESSOR, 			//0x5C
	CLASS_BATTLE_GIRL,	 		//0x5D
	CLASS_PKMN_BREEDER, 		//0x5E
	CLASS_PKMN_RANGER,	 		//0x5F
	CLASS_IDOL,		 			//0x60
	CLASS_RUIN_MANIAC, 			//0x61
	CLASS_LADY, 				//0x62
	CLASS_BAD_EGG,	 			//0x63
	CLASS_RESEARCHER, 			//0x64
	CLASS_ARTIST, 				//0x65
	CLASS_BABYSITTER,	 		//0x66
	CLASS_NO_1_TRAINER, 		//0x67
	CLASS_MASTER_THIEVES, 		//0x68
	CLASS_TOGA_GIRL, 			//0x69
