...
#define MAPSEC_VERMILION_PORT               0x80 //Replacing S.S. Anne
#define MAPSEC_ICED_PATH		            0x81 //Replacing Underground Path
...
#define MAPSEC_BATTLE_FRONTIER              0xA7 //Currently Trainer Tower, will be replaced... someday!
