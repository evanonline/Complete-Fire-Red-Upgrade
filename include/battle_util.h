...
#define WEATHER_HAS_EFFECT (!AbilityBattleEffects(ABILITYEFFECT_CHECK_ON_FIELD, 0, ABILITY_CLOUDNINE, 0, 0))
#define WEATHER_HAS_EFFECT2 (!AbilityBattleEffects(ABILITYEFFECT_FIELD_SPORT, 0, ABILITY_CLOUDNINE, 0, 0))
